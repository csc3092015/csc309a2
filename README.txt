...
- Observe that if a bug eats the food it was trying to eat, it moves toward the next closest.
...
3. Check that bugs disappear when they eat the food.
- Check that when bugs become close to the food, the food and bug disappear.

4. Check that bugs are created every 1 to 3 seconds at correct probabilities.
...
5. Observe that bugs do not walk out of the canvas dimensions.

6. Observe that there are 5 foods in the second half of the canvas.
